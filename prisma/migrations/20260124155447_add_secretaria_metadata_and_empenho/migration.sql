...
CREATE TABLE "secretaria" (
    ...
    "sistema_integrado" VARCHAR(100),
    "fonte_dos_dados" VARCHAR(200),
    "ativo" BOOLEAN NOT NULL DEFAULT true,
    "data_hora_inclusao" TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- CreateIndex
CREATE UNIQUE INDEX "uq_secretaria_prefeitura_sigla" ON "secretaria"("prefeitura_id");
